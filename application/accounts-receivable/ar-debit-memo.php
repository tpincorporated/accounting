...
<div class="modal fade" id="add-debit-memo-posting-details-modal">
...
<div class="modal fade" id="add-debit-memo-account-details-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class='page-title'>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	        ...
	        $(tabARDEBITMEMO+" #ardebitmemo-postingdetailstable").flexigrid({
                ...
                buttons : [
                        {name: 'Add', bclass: 'add', onpress : showadddebitmemopostingdetailsmodal},
                        {separator: true},
       		...
       		$(tabARDEBITMEMO+" #ardebitmemo-accountdetailstable").flexigrid({
                ...
                buttons : [
                        {name: 'Add', bclass: 'add', onpress : showadddebitmemoaccountdetailsmodal},
                        {separator: true},
                        {name: 'Delete', bclass: 'delete', onpress : ''}
                        /*{separator: true},
                        {name: 'Delete', bclass: 'delete deletecarrierbtn', onpress : deleteCarrier}*/
			   ...
			   function showadddebitmemopostingdetailsmodal(){
			$("#add-debit-memo-posting-details-modal").modal('show')
		}

		function showadddebitmemoaccountdetailsmodal(){
			$("#add-debit-memo-account-details-modal").modal('show')
		}
